...
#         # Technical/informational terms that indicate NOT an agent request
#         info_terms = {'know', 'understand', 'learn', 'about', 'explain', 'tell', 
#                      'information', 'what', 'how', 'why', 'handshaking', 'tcp', 
#                      'http', 'data', 'protocol', 'api'}
        
#         # Agent keywords that MUST be present
...
#         # If has informational terms but NO agent keywords, return 0
...
#             ],
#             patterns=[
#                 # Require agent/human keywords to be present
#                 r'\b(speak|talk|connect|transfer|escalate)\s+(to|with|me\s+(to|with))\s+(an?\s+)?(agent|human|representative|someone|person|operator)\b',
...
#                            'speak to representative', 'want to talk to']
#         ),
